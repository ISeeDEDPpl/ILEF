...
namespace ILEF.Core
{
    ...
    public class State
    {
        ...
        void OnFrame(object sender, EventArgs e)
        {
            ...
            {
                if (CurState != null && ((QMCache.Instance.DirectEve.Session.IsReady && (QMCache.Instance.DirectEve.Session.IsInSpace || QMCache.Instance.DirectEve.Session.IsInStation)))) //.NextSessionChange < Session.Now) || SafetyOff))
                {
