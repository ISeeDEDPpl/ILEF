...
namespace ILEF.SessionControl.UI
{
    internal partial class SessionControl : Form
    {
        internal LoginGlobalSettings GlobalConfig = ILEF.SessionControl.SessionControl.Instance.GlobalConfig;
        internal LoginLocalSettings Config = ILEF.SessionControl.SessionControl.Instance.Config;
        ...
        private void numLoginDelta_ValueChanged(object sender, EventArgs e)
        {
            ...
            Config.Save();
            ILEF.SessionControl.SessionControl.Instance.NewLoginDelta();
        }
        ...
        private void numDowntimeDelta_ValueChanged(object sender, EventArgs e)
        {
            ...
            Config.Save();
            ILEF.SessionControl.SessionControl.Instance.NewDowntimeDelta();
        }
