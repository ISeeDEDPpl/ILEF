...
namespace ILEF.KanedaToolkit
{
    ...
    public static class KAgent
    {
        ...
        /// </summary>
        public static bool HasStanding(this DirectAgent agent)
        {
            if (!Standing.Ready)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool HasMissionOffered(this DirectAgent agent)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool HasMissionAccepted(this DirectAgent agent)
        {
            return HasMission(agent, AgentMission.MissionState.Accepted);
        }

        private static bool HasMission(DirectAgent agent, AgentMission.MissionState state)
        {
